from sqlalchemy import Column, Integer, String, DateTime, Boolean, ForeignKey, Text, Date, Time, Index
...
class Usuario(Base):
    ...
    rol = Column(String(10), nullable=False)  # 'admin', 'cliente'
...
class Turno(Base):
    ...
    # Relaciones
    cliente = relationship("Usuario", back_populates="turnos")
